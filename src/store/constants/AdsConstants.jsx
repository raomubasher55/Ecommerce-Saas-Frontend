...
export const FETCH_UNCONFIRMED_ADS_REQUEST = "FETCH_UNCONFIRMED_ADS_REQUEST";
export const FETCH_UNCONFIRMED_ADS_SUCCESS = "FETCH_UNCONFIRMED_ADS_SUCCESS";
export const FETCH_UNCONFIRMED_ADS_FAILURE = "FETCH_UNCONFIRMED_ADS_FAILURE";
