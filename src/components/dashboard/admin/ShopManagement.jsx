      ...
      {expandedStore && (
        <div className="mt-6 p-4 bg-gray-50 rounded-lg relative">
          ...
          {displayedStores
            ...
            .map(store => (
              <div key={store._id}>
                <h3 className="text-lg font-semibold  mb-4 text-[#4222C4]">{store.name} - Store Details</h3>
                ...
                {store.status === "suspended" ? (
                  <button
                    className="absolute right-4 top-3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                  ...
                  <button
                    className="absolute right-4 top-3 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
