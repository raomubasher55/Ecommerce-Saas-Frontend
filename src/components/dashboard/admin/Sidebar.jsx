import {
    FaBars, FaHome, FaUsers, FaStore, FaBox, FaMoneyBillAlt,
    FaChartPie, FaBullhorn, FaHandshake,
    FaComments,
  } from "react-icons/fa";
import { IoInformation } from "react-icons/io5";
  ...
  export default function Sidebar({ toggleSidebar, isSidebarOpen, setActiveComponent, activeComponent }) {
    const menuItems = [
      ...
      {name: "Info" , icon: <IoInformation/>},
      {name: "Store Status" ,icon: <FaStore/>},
    ];
  
    return (
      <div
        className={`bg-gray-100 h-max text-gray-800 border ${
