      ...
      <form onSubmit={sendMessage} className="p-4 bg-white border-t">
        <div className="flex items-center">
          <input
            ...
            className="flex-1 p-3 border rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#4222C4]"
            disabled={sending}
          />
          <button
            type="submit"
            className="bg-[#4222C4] text-white p-3 rounded-r-lg hover:bg-[#3a1da9] focus:outline-none disabled:opacity-50"
