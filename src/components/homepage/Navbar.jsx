    ...
    <div className="w-full bg-white shadow-md px-5">
      ...
      <div className="max-w-screen-xl mx-auto py-4 flex justify-around items-center">
        ...
        >
          ...
          {storeToken ? "Shop Dashbaord" : "Become a Seller"}
            ...
            <div className="absolute left-0 z-50 mt-36 w-max bg-white border rounded-md shadow-lg">
              ...
              {!storeToken && (
                <>
                  ...
                  >
                    <FaUserPlus className="text-[#4222C4]" /> Register Store
                  </button>
                  <button
                    onClick={() => navigate("/login-store")}
                    className="flex items-center gap-2 w-full px-4 py-2 text-gray-700 hover:bg-gray-100"
                  >
                    <FaSignInAlt className="text-[#4222C4]" /> Login Store
                  </button>
                </>
              )}
              ...
              {storeToken && (
                <div>
                  ...
                  >
                    <FaTachometerAlt className="text-[#4222C4]" /> Shop Dashboard
                  </button>
        ...
        <div className="flex items-center w-max">
          <div className="flex items-center space-x-2 text-gray-800 text-sm">
            ...
            {/* Deals & Offers */}
            <Link to={'/cebelu/deals'} className=" w-max flex mr-5 md:mr-0">Deals & Offers</Link>
            {!storeToken && (
              <>
      ...
      {isWishlistOpen && (
        ...
        >
          ...
          {/* Wishlist Title */}
          <h2 className="text-lg font-bold text-[#4222C4] mb-3">Your Wishlist</h2>
