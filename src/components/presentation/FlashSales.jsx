          ...
          >
            {discountedProducts?.map((product) => (
              <SwiperSlide key={product._id} className="p-4 border-2 rounded-lg shadow-md bg-white relative group">
                ...
                Price: <span className='text-sm'>A.D </span>{product.discountedPrice.toFixed(1)}
                </p>
                <p className="text-gray-500 line-through text-center text-sm mt-1">Price: <span className='text-sm'>A.D </span>{product.price}</p>
